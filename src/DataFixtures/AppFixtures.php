...
class AppFixtures extends Fixture
{
    public function load(ObjectManager $manager): void
    {
        ...
        $course1->setDescription('Станьте ИТ-инженером и получите одну из самых востребованных профессий.' .
            'Вы изучите основы программирования и основные концепции компьютерных наук, цифровые технологии, программное обеспечение, операционные системы,' .
        ...
        $lesson1_1->setContent('Расскажем, как спланировать обучение, чтобы сохранить интерес, получить максимум пользы и всё успеть.');
        ...
        $lesson1_2->setContent('Познакомитесь с языками программирования: функциями и массивами, рекурсиями и двумерными массивами.' .
        ...
        $lesson1_3->setContent('Познакомитесь с понятием «базы данных», разберетесь с их видами и основными подходами к работе с данными.' .
        ...
        $lesson1_4->setContent('Изучите колесо компетенций и матрицу Декарта. Познакомитесь со специализациями и выберете дальнейшее направление развития.');
        ...
        $lesson3_2->setContent('Налоговый кодекс.
                                        ...
                                        Налоговые проверки.
                                        Практикум: выбрать систему налогообложения и систему отчётности для организации.');
